...
set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS33} [get_ports adc_din]
set_property -dict {PACKAGE_PIN K3 IOSTANDARD LVCMOS33} [get_ports adc_csn]
set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS33} [get_ports adc_clk]
set_property -dict {PACKAGE_PIN H1 IOSTANDARD LVCMOS33} [get_ports adc_dout]
